    ...
    >
      ...
      >
        ...
        <div className="space-y-4 text-gray-600">
          <p>
            Your event{" "}
            <span className="font-semibold text-gray-800">{eventName}</span> has
            been submitted and is pending approval.
          </p>
          <div className="bg-amber-50 p-4 rounded-lg border border-amber-100">
            <p className="font-medium text-amber-800">
              All new events require administrator approval before they become
              visible to other users.
            </p>
          </div>
          <p>
            The approval process typically takes{" "}
            <span className="font-semibold">up to 24 hours</span>. You'll
            receive an email notification once your event has been approved.
          </p>
          <p className="text-sm">
            If your event hasn't been approved within 24 hours, please contact{" "}
            <a
